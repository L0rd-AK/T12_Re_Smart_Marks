...
const MidtermMarks: React.FC = () => {
  ...
  useEffect(() => {
    localStorage.setItem('questionFormats', JSON.stringify(questionFormats));
  }, [questionFormats]);
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                >
                  <h3 className="font-semibold text-blue-800">Simple Format</h3>
                  <p className="text-sm text-gray-600">5 questions, 5 marks each</p>
                </button>
                <button
                ...
                >
                  <h3 className="font-semibold text-green-800">Sub-question Format</h3>
                  <p className="text-sm text-gray-600">1a, 1b, 2a, 2b, 3, 4, 5</p>
                </button>
              </div>
            </div>
                  ...
                  {questionFormats.map(format => (
                    ...
                    >
                      ...
                      <div className="text-sm text-gray-600">
                        {format.questions.length} questions, {format.questions.reduce((sum, q) => sum + q.maxMark, 0)} total marks
                      </div>
                    </button>
                  ))}
                </div>
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="bg-white rounded-lg shadow-lg p-6 text-black">
          ...
          <div className="flex justify-between items-center mb-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-800">Midterm Marks Entry</h1>
